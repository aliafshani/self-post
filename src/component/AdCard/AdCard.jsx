...
export default function AdCard({ name, loc, weight }) {
    return (
        <div className='w-3/12 border-2 flex bg-white cursor-pointer hover:[box-shadow:rgba(0,_0,_0,_0.25)_0px_14px_28px,_rgba(0,_0,_0,_0.22)_0px_10px_10px] delay-200 ease-in-out transition-all rounded-lg mt-10 border-purple-800 m-2 '>
            <img className='w-6/12 rounded-lg' src="./public/mahanAir.png" alt="" />
